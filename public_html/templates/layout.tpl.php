...
<?php if (isset($_SESSION['isauth'])): ?>    
                  <a class="main-header__add-lot button" href="/?tab=add_lot">Добавить лот</a>
        ...
        <nav class="user-menu">                  
          ...
          <div class="user-menu__logged">
              <p><?=only_first_word($_SESSION['user']['name'])?></p>
          </div>
      <?php else: ?>      

    <ul class="user-menu__list">
    <li class="user-menu__item">
      <a href="/?tab=registration">Регистрация</a>
    </li>
    <li class="user-menu__item">
...
<nav class="nav">
    ...
    <?php foreach ($categories as $key => $value):?>
      <li class="nav__item">
        <a href="/?tab=<?=$categories[$key]['name_en']?>"><?=$categories[$key]['name']?></a>
      </li>
      <?php endforeach;?>
    </ul>
  </nav>
